import requests #la bibliothèque permet d'interroger des site internet
from lxml import etree #la bibliothèque permet d'analyser les fichier xml et on import uniquement la fonction etree
import time #import la bibliothèque time
